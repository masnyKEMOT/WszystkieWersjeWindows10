@call :init  MediaCreationTool.bat - Najnowsza Wersja Dostepna na pastebin.com/bBw0Avc4 albo git.io/MediaCreationTool.bat
:: Uniwersalny Skrypt Stworzony dzieki Xedos (Kod zdoby³em z git.io/MediaCreationTool.bat od AveYo)- dla wszystkich wersji systemu Windows 10 od 1507 do 21H1!
:: Tylko linki Ÿród³owe hostowane przez Microsoft i ¿adnych narzêdzi innych firm - skrypt po prostu konfiguruje xml i uruchamia MCT!
:: Genialne wsparcie dla wersji biznesowych (Enterprise / VL), wybieraj¹c jêzyk, x86, x64 lub AiO w MCT GUI!
:: Zmiany: 2021.03.20
:: - wersja wstêpna 21H1; opcjonalna automatyczna aktualizacja lub utwórz ustawienia noœników importuj¹c folder $ OEM $ i klucz jako PID.txt
...
:: komentarz, aby nie odkrywaæ Enterprise for 1709+ w pliku products.xml
set/a UNHIDE_BUSINESS=1

:: komentuj, aby nie wstawiaæ ³¹czy Enterprise ESD dla 1607,1703 lub aktualizuj ³¹cza dla 1909,2004,2104 w products.xml
set/a UPDATE_BUSINESS=1

:: odkomentuj, aby omin¹æ wybór okna dialogowego gui i zakodowaæ na sta³e wersjê MCT: 1=1507, 2=1511, .. 10=20H1, 11=20H2, 12=21H1
rem set/a VER=12

:: odkomentuj, aby rozpocz¹æ automatyczn¹ aktualizacjê bez monitów - lub po prostu zmieñ nazwê skryptu na "auto MediaCreationTool.bat"
rem set/a AUTO=1
...
:: choices dialog
if not defined VER call :choices VER "%CHOICES%" 12 "Wybierz Wersje Windows Media" 11 white dodgerblue 300
@goto choice-%VER%
